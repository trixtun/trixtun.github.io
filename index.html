...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="https://trixtun.github.io/">Tushar Takshak</a>
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="https://drive.google.com/file/d/1hz97Ooy190txIDKUGSQjWnabQl6wnJnx/view?usp=sharing">Resume</a>
      </li>
...
<div class="jumbotron">
  ...
  <a class="btn btn-primary btn-lg" href="#" role="button">Press Me</a>
</div>
